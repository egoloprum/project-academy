...
export const ProfileInfoForm = ({}) => {
  return (
    <motion.form
      action=""
      className="grid sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 gap-4 sm:gap-y-8 w-full lg:max-w-160 xl:max-w-full"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      ...
      <motion.button
        className="sm:w-fit border px-10 py-2 mt-4 text-sm text-black font-medium rounded-md bg-lime-300 hover:lime-400 active:lime-500 cursor-pointer border-none"
